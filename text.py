...
tickets_text = '''Билеты строго в ограниченном количестве, цена в каждом релизе возрастает, <b>возможен SOLD OUT</b>. Если и останутся, то на входе будет дороже.
...
tickets_push_text = '''
<a href='https://www.mdivisionpromo.com/mfamily'>m_family</a> ждет в эту субботу.
