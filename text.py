...
tickets_text = '''Билеты строго в ограниченом количестве, цена в каждом релизе возрастает, <b>возможен SOLD OUT</b>. Если и останутся, то на входе будет дороже.
...
tickets_push_text = '''
<a href='https://www.mdivisionpromo.com/mfamily'><b><m_family></b></a> ждет в эту субботу.
Билеты строго в ограниченом количестве, цена в каждом релизе возрастает, <b>возможен SOLD OUT</b>. Если и останутся, то на входе будут дороже.
