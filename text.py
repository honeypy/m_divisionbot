...
timetable = '''Пока известен только лайнап, расписание будет известно ближе к началу мероприятия:
...
Фестиваль GAMMA начнется 19 июля, а закончится 23 июля утром и пройдет на 10 сценах и в 4 локациях Санкт-Петербурга.
